...
\begin{itemize}
    \item \textbf{SVM (RBF Kernel):} Đạt 100\% độ chính xác nhờ khả năng phân tách tốt, tổng quát hóa mạnh và kết hợp chuẩn hóa L2, tốt với các điều kiện môi trường khác nhau, độ chính xác trung bình cao. Thời gian xử lý chấp nhận được cho real-time.
    
    \item \textbf{KNN:} Độ chính xác 100\% trên tập test không đảm bảo hiệu suất thực tế. Kết quả trung bình cho thấy KNN chỉ đạt ~91\% với độ lệch chuẩn ±8.57\%. Điều này chứng minh KNN học vẹt không ổn định và phù hợp hơn cho môi trường với dữ liệu đa dạng..
